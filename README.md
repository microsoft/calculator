...
The app provides standard, scientific, and programmer calculator functionalities, as well as a set of converters between various units of measurement and currencies.

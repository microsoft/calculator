...
StandardPeers::AutomationNotificationKind
NotificationHost::GetWindowsNotificationKind(
...
NotificationHost::GetWindowsNotificationProcessing(
  ...
  case CustomPeers::AutomationNotificationProcessing::CurrentThenMostRecent:
    return StandardPeers::AutomationNotificationProcessing::

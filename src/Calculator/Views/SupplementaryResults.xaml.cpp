...
Object ^ DelighterUnitToStyleConverter::Convert(Object ^ value,
                                                TypeName /*targetType*/,
...
Object ^ DelighterUnitToStyleConverter::ConvertBack(Object ^ /*value*/,
                                                    TypeName /*targetType*/,
                                                    Object ^ /*parameter*/,
                                                    String ^
                                                    /*language*/) {
...
Windows::UI::Xaml::DataTemplate ^
    SupplementaryResultDataTemplateSelector::SelectTemplateCore(
...
SupplementaryResults::SupplementaryResults() { InitializeComponent(); }
...
bool SupplementaryResultNoOverflowStackPanel::ShouldPrioritizeLastItem() {
  ...
  auto lastChild =
      dynamic_cast<FrameworkElement ^>(Children->GetAt(Children->Size - 1));

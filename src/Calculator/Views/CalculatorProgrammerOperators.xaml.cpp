...
DEPENDENCY_PROPERTY_INITIALIZATION(CalculatorProgrammerOperators,
                                   SymbolButtonStyle);
...
void CalculatorProgrammerOperators::HexButtonChecked(_In_ Object ^ sender,
                                                     _In_ RoutedEventArgs ^ e) {
  TraceLogger::GetInstance().LogRadixButtonUsed(
...
void CalculatorProgrammerOperators::DecButtonChecked(_In_ Object ^ sender,
                                                     _In_ RoutedEventArgs ^ e) {
  TraceLogger::GetInstance().LogRadixButtonUsed(
      ApplicationView::GetApplicationViewIdForWindow(
          CoreWindow::GetForCurrentThread()));
...
void CalculatorProgrammerOperators::OctButtonChecked(_In_ Object ^ sender,
                                                     _In_ RoutedEventArgs ^ e) {
  TraceLogger::GetInstance().LogRadixButtonUsed(
      ApplicationView::GetApplicationViewIdForWindow(
          CoreWindow::GetForCurrentThread()));
...
void CalculatorProgrammerOperators::BinButtonChecked(_In_ Object ^ sender,
                                                     _In_ RoutedEventArgs ^ e) {
  TraceLogger::GetInstance().LogRadixButtonUsed(
      ApplicationView::GetApplicationViewIdForWindow(
          CoreWindow::GetForCurrentThread()));
...
void CalculatorProgrammerOperators::OnCopyMenuItemClicked(_In_ Object ^ sender,
                                                          _In_ RoutedEventArgs ^
                                                              e) {
  auto source =
      safe_cast<RadixButton ^>(ProgrammerOperatorsContextMenu->Target);

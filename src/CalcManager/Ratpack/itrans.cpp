...
void asinanglerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
                  int32_t precision)
...

{
  ...
  if (rat_le(phack, rat_smallest, precision) &&
...
void acosanglerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
                  int32_t precision)
...
void atananglerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
                  int32_t precision)

...
void scalerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
              int32_t precision) {
  switch (angletype) {
  case ANGLE_RAD:
...

{
  ...
  if (rat_le(*px, rat_smallest, precision) &&
      rat_ge(*px, rat_negsmallest, precision)) {
    DUPRAT(*px, rat_zero);
  }
}
...
void sinanglerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
                 int32_t precision)
...
void cosanglerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
                 int32_t precision)
...
void tananglerat(_Inout_ PRAT *pa, ANGLE_TYPE angletype, uint32_t radix,
                 int32_t precision)

...
private:
    ...
    int m_nLastOpCode;     /* ID value of the last operator.                       */
    int m_nBinaryOpCode;     /* ID value of most recent binary operator.                       */
    int m_nPrevBinaryOpCode; // binary operator which computed the number in m_currentVal. 0 if it is already bracketed or plain number or

...
extern void ValidateViewModelByCommands(StandardCalculatorViewModel ^ viewModel,
                                        TESTITEM item[], bool doReset = false);
...
// Perform calculations on different calculator modes and verify that they work
// independently
TEST_METHOD(MultipleModesCalculationTest) {
  ...
  // Perform Calculations on all instances and check that they work
  // independently
  ...
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[2]->HexDisplayValue),
                   StringReference(L"F"));
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[2]->DecimalDisplayValue),
                   StringReference(L"15"));
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[2]->OctalDisplayValue),
                   StringReference(L"17"));
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[2]->BinaryDisplayValue),
                   StringReference(L"1111"));

  // Assert that Standard and Scientific mode Display Values are unchanged
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[0]->DisplayValue),
                   StringReference(L"3"));
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[1]->DisplayValue),
                   StringReference(L"7"));
}

// Perform calculations on 2 instances of Calculator in Standard Mode and verify
// that they work independently
TEST_METHOD(MultipleStandardModeCalculationTest) {
  // Create 2 instances of Standard Mode
  StandardCalculatorViewModel ^ standardViewModel1 =
      ref new StandardCalculatorViewModel();
  StandardCalculatorViewModel ^ standardViewModel2 =
      ref new StandardCalculatorViewModel();
  ...
  // Perform Calculations on the 2 instances and check that they work
  // independently
  ...
  VERIFY_ARE_EQUAL(GetStringValue(standardViewModel1->DisplayValue),
                   StringReference(L"1"));
}

// Perform calculations on 2 instances of Calculator in Scientific Mode and
// verify that they work independently
TEST_METHOD(MultipleScientificModeCalculationTest) {
  // Create 2 instances of Standard Mode
  StandardCalculatorViewModel ^ scientificViewModel1 =
      ref new StandardCalculatorViewModel();
  StandardCalculatorViewModel ^ scientificViewModel2 =
      ref new StandardCalculatorViewModel();
  ...
  TESTITEM scientificModeTestItems1[] = {
      ...
      {NumbersAndOperatorsEnum::Equals, L"1", L""},
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(scientificViewModel1, scientificModeTestItems1,
                              true);
  ...
  TESTITEM scientificModeTestItems2[] = {
      ...
      {NumbersAndOperatorsEnum::Equals, L"20", L""},
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(scientificViewModel2, scientificModeTestItems2,
                              true);

  // Assert that the Display Value of 1st instance is unchanged
  VERIFY_ARE_EQUAL(GetStringValue(scientificViewModel1->DisplayValue),
                   StringReference(L"1"));
}

// Perform calculations on 2 instances of Calculator in Scientific Mode
// (with different Angle types, HYP and F-E settings) and verify that they work
// independently
TEST_METHOD(MultipleScientificModeWithDifferentSettingsTest) {
  ...
  TESTITEM scientificModeInitializeItems1[] = {
      ...
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(scientificViewModel1,
                              scientificModeInitializeItems1, true);
  ...
  TESTITEM scientificModeInitializeItems2[] = {
      ...
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(scientificViewModel2,
                              scientificModeInitializeItems2, true);
  ...
  TESTITEM scientificModeTestItems2[] = {
      {NumbersAndOperatorsEnum::Pi, L"3.1415926535897932384626433832795e+0",
       L""},
...
// Perform calculations on 2 instances of Calculator in Programmer Mode and
// verify that they work independently
TEST_METHOD(MultipleProgrammerModeCalculationTest) {
  // Create 2 instances of Standard Mode
  StandardCalculatorViewModel ^ programmerViewModel1 =
      ref new StandardCalculatorViewModel();
  StandardCalculatorViewModel ^ programmerViewModel2 =
      ref new StandardCalculatorViewModel();
  ...
  ValidateViewModelByCommands(programmerViewModel1, programmerModeTestItems1,
                              false);
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->HexDisplayValue),
                   StringReference(L"F"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->DecimalDisplayValue),
                   StringReference(L"15"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->OctalDisplayValue),
                   StringReference(L"17"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->BinaryDisplayValue),
                   StringReference(L"1111"));
  ...
  ValidateViewModelByCommands(programmerViewModel2, programmerModeTestItems2,
                              false);
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->HexDisplayValue),
                   StringReference(L"7"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->DecimalDisplayValue),
                   StringReference(L"7"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->OctalDisplayValue),
                   StringReference(L"7"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->BinaryDisplayValue),
                   StringReference(L"0111"));

  // Assert that displayed values of 1st instance are unchanged
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->DisplayValue),
                   StringReference(L"F"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->HexDisplayValue),
                   StringReference(L"F"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->DecimalDisplayValue),
...
// (with different Bit lengths and Radix types) and verify that they work
// independently
TEST_METHOD(MultipleProgrammerModeWithDifferentSettingsTest) {
  ...
  ValidateViewModelByCommands(programmerViewModel1,
                              programmerModeInitializeItems1, false);
  ...
  ValidateViewModelByCommands(programmerViewModel2,
                              programmerModeInitializeItems2, false);
  ...
  ValidateViewModelByCommands(programmerViewModel1, programmerModeTestItems1,
                              false);
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->HexDisplayValue),
                   StringReference(L"FF"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->DecimalDisplayValue),
                   StringReference(L"-1"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->OctalDisplayValue),
                   StringReference(L"377"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel1->BinaryDisplayValue),
                   StringReference(L"1111 1111"));
  ...
  ValidateViewModelByCommands(programmerViewModel2, programmerModeTestItems2,
                              false);
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->HexDisplayValue),
                   StringReference(L"7FFF"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->DecimalDisplayValue),
                   StringReference(L"32,767"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->OctalDisplayValue),
                   StringReference(L"77 777"));
  VERIFY_ARE_EQUAL(GetStringValue(programmerViewModel2->BinaryDisplayValue),
                   StringReference(L"0111 1111 1111 1111"));
}

// Perform calculations on 2 separate instances of Calculator and verify that
// their History list items are maintained separately
TEST_METHOD(MultipleModesHistoryAddItemTest) {
  std::vector<StandardCalculatorViewModel ^> viewModels(2);

  // Create 3 instances of StandardCalculatorViewModel in Standard and
  // Scientific mode
  for (int i = 0; i < 2; i++) {
    viewModels[i] = ref new StandardCalculatorViewModel();
    ...
    VERIFY_IS_TRUE(
        0 ==
        viewModels[i]->m_standardCalculatorManager.GetHistoryItems().size());
  }

  // Perform Calculations on both the instances and check that the History items
  // work independently
  ...
  VERIFY_IS_TRUE(
      1 == viewModels[0]->m_standardCalculatorManager.GetHistoryItems().size());
  ...
  VERIFY_ARE_EQUAL(
      expression1,
      StringReference(item1->historyItemVector.expression.c_str()));
  VERIFY_ARE_EQUAL(result1,
                   StringReference(item1->historyItemVector.result.c_str()));

  // Assert for the history list items of 2nd instance
  VERIFY_IS_TRUE(
      1 == viewModels[1]->m_standardCalculatorManager.GetHistoryItems().size());

  auto item2 = viewModels[1]->m_standardCalculatorManager.GetHistoryItem(0);
  String ^ expression2 = UtfUtils::LRO + L"1   +   2   " + UtfUtils::MUL +
                         L"   3 =" + UtfUtils::PDF;
  String ^ result2 = L"7";

  VERIFY_ARE_EQUAL(
      expression2,
      StringReference(item2->historyItemVector.expression.c_str()));
  VERIFY_ARE_EQUAL(result2,
                   StringReference(item2->historyItemVector.result.c_str()));
}

// Perform calculations on 2 separate instances of Standard Modes and verify
// that their History list items are maintained separately
TEST_METHOD(MultipleStandardModesHistoryAddItemTest) {
  ...
  String ^ expression[] = {UtfUtils::LRO + L"1   +   2 =" + UtfUtils::PDF,
                           UtfUtils::LRO + L"1   +   2   " + UtfUtils::MUL +
                               L"   3 =" + UtfUtils::PDF};
  ...
  for (int i = 0; i < 2; i++) {
    ...
    VERIFY_ARE_EQUAL(
        expression[i],
        StringReference(item->historyItemVector.expression.c_str()));
    VERIFY_ARE_EQUAL(result[i],
                     StringReference(item->historyItemVector.result.c_str()));
  }
}

// Perform calculations on 2 separate instances of Scientific Modes and verify
// that their History list items are maintained separately
TEST_METHOD(MultipleScientificModesHistoryAddItemTest) {
  ...
  String ^ expression[] = {UtfUtils::LRO + L"1   +   2 =" + Utils::PDF,
                           UtfUtils::LRO + L"1   +   2   " + UtfUtils::MUL +
                               L"   3 =" + Utils::PDF};
...
// Perform calculations on 3 separate instances of Calculator and verify that
// their Memory List items are maintained separately
TEST_METHOD(MultipleModesMemoryAddItemTest) {
  ...
  // Perform Calculations on both the instances and check that the Memory items
  // work independently
  ...
  String ^ expectedMemoryValues[] = {UtfUtils::LRO + L"3" + UtfUtils::PDF,
...
TEST_METHOD(MultipleDateCalculatorTest) {
  ...
  //    VERIFY_ARE_EQUAL(StringReference(L"Same dates"),
  //    viewModels[i]->StrDateDiffResult);
  ...
  ///* 01-10-2015 */ date1.wDay = 1; date1.wMonth = 10; date1.wYear = 2015;
  /// date1.wDayOfWeek = 4; date1.wHour = 0; date1.wMinute = 0; date1.wSecond =
  /// 0; date1.wMilliseconds = 0;
  ///* 15-02-2016 */ date2.wDay = 15; date2.wMonth = 2; date2.wYear = 2016;
  /// date2.wDayOfWeek = 1; date2.wHour = 0; date2.wMinute = 0; date2.wSecond =
  /// 0; date2.wMilliseconds = 0;
  ...
  ///* 12-12-2015 */ date1.wDay = 12; date1.wMonth = 12; date1.wYear = 2015;
  /// date1.wDayOfWeek = 6;
  ///* 15-12-2015 */ date2.wDay = 15; date2.wMonth = 12; date2.wYear = 2015;
  /// date2.wDayOfWeek = 2;
  ///* 17-01-2018 */ resultDate.wDay = 17; resultDate.wMonth = 1;
  /// resultDate.wYear = 2018; resultDate.wDayOfWeek = 3; resultDate.wHour = 0;
  /// resultDate.wMinute = 0; resultDate.wSecond = 0; resultDate.wMilliseconds =
  /// 0;
  ...
  // VERIFY_ARE_EQUAL(StringReference(L"137 days"),
  // viewModels[0]->StrDateDiffResultInDays);
  // VERIFY_ARE_EQUAL(StringReference(L"4 months, 2 weeks"),
  // viewModels[0]->StrDateDiffResult);

  // VERIFY_IS_TRUE(viewModels[1]->IsDiffInDays);
  // VERIFY_ARE_EQUAL(StringReference(L"3 days"),
  // viewModels[1]->StrDateDiffResult);
  // VERIFY_IS_NULL(viewModels[1]->StrDateDiffResultInDays);

  //// TODO - MSFT 10331900 : both GetLongDate and viewmodel return incorrect
  /// values!
  // VERIFY_ARE_EQUAL(DateUtils::GetLongDate(resultDate),
  // viewModels[2]->StrDateResult); VERIFY_ARE_EQUAL(StringReference(L"Date out
  // of Bound"), viewModels[3]->StrDateResult);
}
...
TEST_METHOD(MultipleConverterModeCalculationTest) {
  ...
  for (int i = 0; i < 3; i++) {
    viewModels[i] = ref new UnitConverterViewModel(
        std::make_shared<UnitConversionManager::UnitConverter>(
            std::make_shared<UnitConverterDataLoader>(
                ref new GeographicRegion()),
            nullptr));
  ...
  // viewModels 0 & 1 have same category(Volume) and viewModel 2 has different
  // category(Length)
  int volumeIndex = NavCategory::GetIndexInGroup(ViewMode::Volume,
                                                 CategoryGroupType::Converter);
  int lengthIndex = NavCategory::GetIndexInGroup(ViewMode::Length,
                                                 CategoryGroupType::Converter);
  ...
  for (int i = 0; i < 3; i++) {
    ...
    auto resKey = String::Concat(
        ref new String((unit1Name + L"-" + unit2Name + L"-").c_str()),
        expectedValue1);
...
TEST_METHOD(TestStandardUnitConverterAndDateViewModels) {
  ...
  StandardCalculatorViewModel ^ standardViewModel =
      ref new StandardCalculatorViewModel();
  UnitConverterViewModel ^
      unitConverterViewModel = ref new UnitConverterViewModel(
      std::make_shared<UnitConversionManager::UnitConverter>(
          std::make_shared<UnitConverterDataLoader>(ref new GeographicRegion()),
          nullptr));
  DateCalculatorViewModel ^ dateCalcViewModel =
      ref new DateCalculatorViewModel();
  ...
  int volumeCategoryIndex = NavCategory::GetIndexInGroup(
      ViewMode::Volume, CategoryGroupType::Converter);
  IObservableVector<Category ^> ^ categories =
      unitConverterViewModel->Categories;
  unitConverterViewModel->CurrentCategory =
      categories->GetAt(volumeCategoryIndex);
  ...
  VERIFY_ARE_EQUAL(categories->GetAt(volumeCategoryIndex),
                   unitConverterViewModel->CurrentCategory);
  VERIFY_ARE_EQUAL(unitConverterViewModel->Units->GetAt(2),
                   unitConverterViewModel->Unit1);
  VERIFY_ARE_EQUAL(unitConverterViewModel->Units->GetAt(3),
                   unitConverterViewModel->Unit2);

  // Perform Calculations on these instances and check that they work
  // independently
  ...
  // Validate the Result
  VERIFY_ARE_EQUAL(StringReference(L"2"),
                   GetStringValue(unitConverterViewModel->Value1));
  VERIFY_ARE_EQUAL(StringReference(L"0.002"),
                   GetStringValue(unitConverterViewModel->Value2));

  // Assert that the Display Value of Standard Calc instance is unchanged
  VERIFY_ARE_EQUAL(GetStringValue(standardViewModel->DisplayValue),
                   StringReference(L"1"));

  // Again perform calculations on Standard Calc instance and validate that the
  // Converter remains unaffected
  ...
  VERIFY_ARE_EQUAL(StringReference(L"3"),
                   GetStringValue(standardViewModel->DisplayValue));

  // Validate the Date Calculator
  VERIFY_ARE_EQUAL(DateUtils::GetLongDate(endDate),
                   dateCalcViewModel->StrDateResult);
...
// Change the radix in programmer mode and check that other modes are not
// affected
TEST_METHOD(MultipleModesWithChangeInProgrammerRadix) {
  std::vector<StandardCalculatorViewModel ^> viewModels(3);

  // Create 2 instances of StandardCalculatorViewModel in Standard and
  // Programmer modes
  ...
  TESTITEM programmerModeTestItems[] = {
      ...
      {NumbersAndOperatorsEnum::F, L"F", L""},
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(viewModels[1], programmerModeTestItems,
                              false /*doReset*/);
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[1]->HexDisplayValue),
                   StringReference(L"F"));
  ...
  TESTITEM standardModeTestItems[] = {
      ...
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(viewModels[0], standardModeTestItems,
                              false /*doReset*/);
  ...
  TESTITEM standardModeTestItemsNew[] = {
      ...
      {NumbersAndOperatorsEnum::Equals, L"12", L""},
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(viewModels[2], standardModeTestItemsNew,
                              false /*doReset*/);
  ...
  TESTITEM programmerModeTestItemsNew[] = {
      ...
      {NumbersAndOperatorsEnum::None, L"", L""}};
  ValidateViewModelByCommands(viewModels[1], programmerModeTestItemsNew,
                              true /*doReset*/);
  VERIFY_ARE_EQUAL(GetStringValue(viewModels[1]->HexDisplayValue),
                   StringReference(L"B"));
}

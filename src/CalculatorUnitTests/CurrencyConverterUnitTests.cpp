...
namespace CalculatorUnitTests
{
    ...
    TEST_CLASS(CurrencyConverterUnitTests)
    {
        ...
        TEST_METHOD(Test_RoundCurrencyRatio)
        {
            ...
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.03219), 0.03219);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.03219234), 0.03219);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.003219), 0.003219);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.00321964), 0.003220);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.00123269), 0.001233);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.00012269), 0.0001227);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.00003169), 0.00003169);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.00003161), 0.00003161);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.000031612), 0.00003161);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.000031616), 0.00003162);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.00000671), 0.00000671);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.000006716), 0.000006716);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.000008716134324), 0.000008716);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.000006596134324), 0.000006596);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.0000012169348392), 0.000001217);
            VERIFY_ARE_EQUAL(CurrencyDataLoader::RoundCurrencyRatio(0.000000009034987218), 0.000000009035);
